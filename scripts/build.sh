...
drush -v make --working-copy --no-cache --no-core --contrib-destination="." drupal-org.make tmp
...
cp -r tmp $TEMP_BUILD/profiles/argentinagobar
rm -rf tmp
cp -r . $TEMP_BUILD/profiles/argentinagobar
