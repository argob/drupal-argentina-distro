...
!function( jQuery ) {
 ...
 var frMap = {
  ...
  function normalize(str) {
    jQuery.each(frMap, function (normalized, regex) {
  ...
  var Combobox = function ( element, options ) {
    this.options = jQuery.extend({}, jQuery.fn.combobox.defaults, options)
    this.$source = jQuery(element)
  ...
  Combobox.prototype = jQuery.extend({}, jQuery.fn.typeahead.Constructor.prototype, {

    constructor: Combobox

  , setup: function () {
      var combobox = jQuery(this.options.template)
  ...
  , parse: function () {
      ...
      this.$source.find('option').each(function() {
        ...
        map[normalize(option.text())] = option.val()
        source.push(normalize(option.text()))
  ...
  , lookup: function (event) {
      this.query = normalize(this.$element.val())
  ...
  , listen: function () {
      ...
      this.$button
        .on('click', jQuery.proxy(this.toggle, this))
    }
  ...
  template: '<div class="combobox-container"><input type="hidden" /><input class="test" id="pac-input" type="text" autocomplete="off" placeholder="Buscá tu NAC..." /><span class="add-on btn dropdown-toggle" data-dropdown="dropdown"><span class="caret"/><span class="combobox-clear"><i class="icon-remove"/></span></span></div>'
  , menu: '<ul class="typeahead typeahead-long dropdown-menu selectpicker" role="menu"></ul>'
  , item: '<li><a href="#"></a></li>'
  }

  jQuery.fn.combobox.Constructor = Combobox
